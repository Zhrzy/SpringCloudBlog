...
import com.zy.blog.service.mapper.WebConfigMapper;
...
import com.zy.blog.utils.enums.EAccountType;
import com.zy.blog.utils.enums.ELoginType;
 ...
 *
 * @author 小章鱼
 * @date 2021年11月11日15:10:41
 */
@Service
public class WebConfigServiceImpl extends ServiceImplBase<WebConfigMapper, WebConfig> implements WebConfigService {
    ...
    @Override
    public String editWebConfig(WebConfigView webConfigVO) {
