...
import com.zy.blog.service.mapper.LinkMapper;
...
@Service
@Slf4j
public class LinkServiceImpl extends ServiceImplBase<LinkMapper, Link> implements LinkService {
    ...
    @Override
    public IPage<Link> getPageList(LinkView linkVO) {
        QueryWrapper<Link> queryWrapper = new QueryWrapper<>();
    ...
    @Override
    public String addLink(LinkView linkVO) {
        Link link = new Link();
    ...
    @Override
    public String editLink(LinkView linkVO) {
    ...
    @Override
    public String deleteLink(LinkView linkVO) {
        Link link = linkService.getById(linkVO.getUid());
    ...
    @Override
    public String stickLink(LinkView linkVO) {
        Link link = linkService.getById(linkVO.getUid());
        //查找出最大的那一个
        QueryWrapper<Link> queryWrapper = new QueryWrapper<>();
        queryWrapper.orderByDesc(SQLConf.SORT);
