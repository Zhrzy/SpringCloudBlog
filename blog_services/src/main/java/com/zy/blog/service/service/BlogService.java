 ...
 **/
public interface BlogService extends ServiceBase<Blog> {
     ...
     * @return
     */
    public IPage<Blog> getPageList(BlogView BlogView);
     ...
     * @param BlogView
     */
    public String addBlog(BlogView BlogView);
     ...
     * @param BlogView
     */
    public String editBlog(BlogView BlogView);
     ...
     * @param BlogView
     */
    public String deleteBlog(BlogView BlogView);
