 ...
 **/
@Service
public class BlogSortServiceImpl extends ServiceImplBase<BlogSortMapper, BlogSort> implements BlogSortService {
    ...
    @Override
    public IPage<BlogSort> getPageList(BlogSortView blogSortVO) {
    ...
    @Override
    public String addBlogSort(BlogSortView blogSortVO) {
        // 判断添加的分类是否存在
        QueryWrapper<BlogSort> queryWrapper = new QueryWrapper<>();
    ...
    @Override
    public String editBlogSort(BlogSortView blogSortVO) {
    ...
    @Override
    public String stickBlogSort(BlogSortView blogSortVO) {
        BlogSort blogSort = blogSortService.getById(blogSortVO.getUid());
