...
import com.zy.blog.picture.mapper.FileMapper;
import com.zy.blog.picture.service.FileService;
import com.zy.blog.picture.service.FileSortService;
import com.zy.blog.picture.service.LocalFileService;
import com.zy.blog.picture.service.MinioService;
...
@Slf4j
@Service
public class FileServiceImpl extends ServiceImplBase<FileMapper, File> implements FileService {
...
//                        remap.put(SysConf.QI_NIU_URL, file.getQiNiuUrl());
    ...
    @Override
    public String uploadPictureByUrl(FileView fileVO) {
        // 获取配置文件
            ...
            if (file != null) {
                ...
                if (SysConf.SUCCESS.equals(code)) {
                    ...
                    if (resultList.size() > 0) {
                        ...
                        // 设置博客详情显示方式
                       if (EFilePriority.MINIO.equals(systemConfig.getContentPicturePriority())) {
                            String minioPictureBaseUrl = systemConfig.getMinioPictureBaseUrl();
