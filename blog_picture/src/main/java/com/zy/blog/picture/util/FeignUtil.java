...
import com.zy.blog.commons.feign.AdminFeignClient;
...
import com.zy.blog.picture.config.RedisConf;
...
public class FeignUtil {
    ...
    public Map<String, String> getSystemConfigMap(String token) {
        ...
        log.info("从redis获取配置:"+jsonResult);
        // 判断Redis中是否有数据
        if (StringUtils.isNotEmpty(jsonResult)) {
            ...
            log.info("getSystemConfigMap 获取系统配置："+resultStr);
    ...
    public SystemConfig getSystemConfig() {
        ...
        log.info("getSystemConfig从redis获取配置:"+token);
