    ...
    <el-dialog title="请选择图片" :visible.sync="dialogVisible" fullscreen :before-close="before_close">
      ...
      >
        ...
        >
          ...
          <div>
            <img      
              v-for="pictures in  getPictureSort(pictureSort)"
              :key="pictures.fileUid"
              class="showPicture"
              @click="checkLogoConfirm(pictures.fileUid,pictures.pictureUrl)"
              :src="pictures.pictureUrl"
            >
...
export default {
 ...
 computed:{
    getPictureSort(){
      return function(pictureSort){  
        console.log(pictureSort.pictures)
        return pictureSort.pictures
