...
export function deleteBatchBlogSort(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blogSort/deleteBatch',
    method: 'post',
    data: params
  })
}
...
export function stickBlogSort(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blogSort/stick',
    method: 'post',
    data: params
  })
}
...
export function blogSortByClickCount(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blogSort/blogSortByClickCount',
    method: 'post',
    params
  })
}
...
export function blogSortByCite(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blogSort/blogSortByCite',
    method: 'post',
    params
  })
}
