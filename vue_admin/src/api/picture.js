...
export function editPicture(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/picture/edit',
    method: 'post',
    data: params
  })
}
...
export function setCover(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/picture/setCover',
    method: 'post',
    data: params
  })
}
...
export function uploadPicsByUrl(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/file/uploadPicsByUrl',
    method: 'post',
    data: params
  })
}
