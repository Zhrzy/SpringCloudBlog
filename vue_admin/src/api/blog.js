...
export function uploadLocalBlog(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blog/uploadLocalBlog',
    method: 'post',
    data: params
  })
}
...
export function editBatchBlog(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blog/editBatch',
    method: 'post',
    data: params
  })
}
...
export function deleteBatchBlog(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/blog/deleteBatch',
    method: 'post',
    data: params
  })
}