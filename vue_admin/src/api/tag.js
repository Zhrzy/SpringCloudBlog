...
export function deleteBatchTag(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/tag/deleteBatch',
    method: 'post',
    data: params
  })
}
...
export function stickTag(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/tag/stick',
    method: 'post',
    data: params
  })
}
...
export function tagSortByClickCount(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/tag/tagSortByClickCount',
    method: 'post',
    params
  })
}
...
export function tagSortByCite(params) {
  return request({
    url: process.env.VUE_APP_ADMIN_API+'/tag/tagSortByCite',
    method: 'post',
    params
  })
}
