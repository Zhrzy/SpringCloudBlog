  ...
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%">
          ...
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-table :data="scope.row.childCategoryMenu" :show-header="showHeader" style="width: 100%">
              ...
              <el-table-column label width="100" align="center">
                <template slot-scope="scope_child">
                  <span v-for="item in menuLevelDictList" :key="item.uid" >
                  <el-tag  v-if="scope_child.row.menuLevel == item.dictValue" :type="item.listClass">{{item.dictLabel}}</el-tag>
                  </span>
                </template>
              </el-table-column>
              ...
              <el-table-column width="100" align="center">
                <template slot-scope="scope">
                  <span v-for="item in yesNoDictList" :key="item.uid">
                      <el-tag  v-if="scope.row.isShow == item.dictValue" :type="item.listClass">{{item.dictLabel}}</el-tag>
                  </span>
              ...
              <el-table-column width="120" align="center">
                <template slot-scope="scope">
                  <span v-for="item in jumpExternalDictList" :key="item.uid" >
                      <el-tag  v-if="scope.row.isJumpExternalUrl == item.dictValue" :type="item.listClass">{{item.dictLabel}}</el-tag>
                  </span>
      ...
      <el-table-column label="菜单级别" width="100" align="center">
        <template slot-scope="scope">
          <span v-for="item in menuLevelDictList" :key="item.uid" >
        <el-tag  v-if="scope.row.menuLevel == item.dictValue" :type="item.listClass">{{item.dictLabel}}</el-tag>
          </span>
      ...
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="菜单等级" :label-width="formLabelWidth" prop="menuLevel">
          <el-select v-model="form.menuLevel" placeholder="请选择">
            <span v-for="item in menuLevelDictList"
              :key="item.uid"
