    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="操作" fixed="right" min-width="250" >
        <template slot-scope="scope">
          ...
          <el-button @click="handleEdit(scope.row)" type="primary" size="small" v-permission="'/admin/restPwd'">编辑</el-button>
          <el-button @click="handleDelete(scope.row)" type="danger" size="small" v-permission="'/admin/restPwd'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
