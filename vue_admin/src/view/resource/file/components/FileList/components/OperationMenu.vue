...
export default {
  ...
  computed: {
    ...
    config() {
		return {'Authorization' : this.otherData.token};
	  },
    //  文件类型索引
    filetype: {
      get() {
  ...
  created() {
    ...
    // 图片上传地址
    //this.uploadPictureHost =  '/cors/storage/uploadFile'
 this.uploadPictureHost =  process.env.VUE_APP_PICTURE_API+'/storage/uploadFile'
